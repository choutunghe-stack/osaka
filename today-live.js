...
'2026-07-19':{dow:'日',area:'梅田・茶屋町',title:'梅田行程完成，駿河屋後直接返回飯店',note:'今天完成阪急梅田總店購物與退稅、Yodobashi Umeda 5樓模型區，以及駿河屋梅田茶屋町店。逛完駿河屋後沒有再加排 animate 或 Mandarake，直接搭車返回 VESSEL INN NAMBA。',tags:['✓ 阪急退稅','✓ Yodobashi','✓ 駿河屋後返程']},
