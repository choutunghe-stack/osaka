...
'2026-07-20':{dow:'一',area:'心齋橋・難波',title:'難波行程完成：PARCO、法善寺與千日前',note:'昨天已完成心齋橋 PARCO、法善寺與難波千日前商店街行程，之後返回 VESSEL INN NAMBA。晚間未確認特定用餐店家，因此不記錄餐廳名稱。',tags:['✓ 心齋橋 PARCO','✓ 法善寺・千日前','✓ 已返回飯店']},
