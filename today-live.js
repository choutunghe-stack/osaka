...
'2026-07-17':{dow:'五',area:'神戶',title:'神戶行程已完成，MOSAIC 周邊散步後搭電車回飯店',note:'今天完成生田神社、元町商店街、北野異人館與神戶牛用餐；神戶塔抵達時已關閉，最後只在 Harborland・MOSAIC 附近簡單逛逛，沒有靠近主要設施，也未搭大摩天輪，之後直接搭電車返回難波。',tags:['✓ 神戶行程完成','✓ MOSAIC 周邊','✓ 已搭電車返程']},
