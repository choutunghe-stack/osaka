...
function apply(){
 ...
 if(transit)transit.textContent=key==='2026-07-19'?'7/19 梅田・心齋橋｜梅田採買已完成，目前在心齋橋逛街；接著買藥妝，再返回難波飯店。':key==='2026-07-18'?'7/18 日本橋・難波｜實際完成：空想機械館、BIC CAMERA、千日前與道頓堀。':key==='2026-07-17'?'7/17 神戶｜MOSAIC 周邊簡單逛逛後，搭電車返回難波。':`7/${Number(key.slice(-2))} ${d.area}｜依當日安排移動。`;
