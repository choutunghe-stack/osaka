(()=>{
const route=['下鴨神社・糺之森','出町柳／鴨川三角洲玩水','上賀茂神社','北大路站','京都站 Porta'];
const transport='最順串法：由下鴨神社北往南走出糺之森，步行接出町柳與鴨川三角洲，安排 30–40 分鐘淺水踩水與放電；之後直接搭計程車北上上賀茂神社。完成後不要回出町柳，改到北大路站搭烏丸線直達京都站。雨後、水流快或孩子疲累時，鴨川段取消。';
function apply(){
 ...
 if(live)live.textContent='京都神社慢旅｜下鴨 → 出町柳鴨川玩水 → 上賀茂 → 北大路 → 京都站。';
}
