...
'2026-07-22':{area:'臨空城・大阪',route:['✓ 臨空城','✓ EDION（愛電王）購買任天堂點數卡與瑪利歐商品','✓ 返回 VESSEL INN NAMBA 整理行李']},
'2026-07-23':{area:'大阪・關西機場・台灣',route:['✓ VESSEL INN NAMBA 退房','✓ 關西國際機場','✓ 搭機返回台灣']}
};
...
function status(key,i,last){
 ...
 if(Object.prototype.hasOwnProperty.call(routes,key))return '完成';
...
function apply(){
 ...
 if(transit)transit.textContent=key==='2026-07-23'?'7/23 回程｜已從 VESSEL INN NAMBA 前往關西國際機場，並搭機返回台灣；本次關西旅行完成。':key==='2026-07-22'?'7/22 臨空城・大阪｜完成臨空城、EDION最後採買，之後返回飯店整理行李。':key==='2026-07-21'?'7/21 大阪・宇治・道頓堀｜實際完成：高島屋、平等院、中村藤吉抹茶、道頓堀與美津の大阪燒。':key==='2026-07-20'?'7/20 心齋橋・難波｜實際完成：心齋橋 PARCO、法善寺、難波千日前商店街與 CoCo壱番屋晚餐。':key==='2026-07-19'?'7/19 梅田・茶屋町｜駿河屋為最後一站，之後直接返回難波飯店。':key==='2026-07-18'?'7/18 日本橋・難波｜實際完成：空想機械館、BIC CAMERA、千日前與道頓堀。':key==='2026-07-17'?'7/17 神戶｜MOSAIC 周邊簡單逛逛後，搭電車返回難波。':key==='2026-07-16'?'7/16 京都｜完成三十三間堂、下鴨神社、鴨川三角洲、上賀茂神社與祇園祭宵山。':'7/15 移動日｜抵達大阪並入住 VESSEL INN NAMBA。';
 const live=root.querySelector('.v31-live div');
 if(live)live.textContent=`實際完成路線｜${d.route.join(' → ')}。`;
}
