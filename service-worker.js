const CACHE='kansai-warm-ui-v10-live-shimogamo';
...
async function inject(response){
  ...
  if(!html.includes('family-ui-v6.js'))html=html.replace('</body>','<script src="./family-ui-v6.js?v=10"></script></body>');
  if(!html.includes('today-live.js'))html=html.replace('</body>','<script src="./today-live.js?v=10"></script></body>');
